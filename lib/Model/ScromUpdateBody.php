...
/**
 * ScromUpdateBody Class Doc Comment
 *
 * @category Class
 * @package  LtiSaasApi
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ScromUpdateBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'scrom_update_body';
    ...
    {
        $this->container['learningobjectid'] = isset($data['learningobjectid']) ? $data['learningobjectid'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['learningobjectid'] === null) {
            $invalidProperties[] = "'learningobjectid' can't be null";
        }
     ...
     *
     * @param int $learningobjectid The ID of the learning object
     *
     * @return $this
     */
