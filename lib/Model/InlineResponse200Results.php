...
class InlineResponse200Results implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param int $totalregistrations The total number of registrations for the course
     *
     * @return $this
     */
     ...
     * Sets totalltitools
     *
     * @param int $totalltitools The total number of LTI tools used in the course
     *
     * @return $this
     */
     ...
     * Sets toolids
     *
     * @param int[] $toolids An array of identifiers of the LTI tools used in the course
     *
     * @return $this
     */
     ...
     * Sets lastaccess
     *
     * @param int $lastaccess The timestamp of the last access to the course
     *
     * @return $this
     */
