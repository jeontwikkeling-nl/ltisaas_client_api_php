...
/**
 * CourseLtiRegistrationsSumByCourse200ResponseResultsInner Class Doc Comment
 *
 * @category Class
 * @package  LtiSaasApi
 * @author   OpenAPI Generator team
 ...
 */
class CourseLtiRegistrationsSumByCourse200ResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'courseLtiRegistrationsSumByCourse_200_response_results_inner';
    ...
    */
     ...
     *
     * @param int|null $totalregistrations The total number of registrations
     *
     * @return self
     */
     ...
     * Sets courseid
     *
     * @param int|null $courseid The identifier of the course
     *
     * @return self
     */
     ...
     * Sets coursename
     *
     * @param string|null $coursename The name of the course
     *
     * @return self
     */
