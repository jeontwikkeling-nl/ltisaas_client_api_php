...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://linqur45.web09.webv.nl/local/ltisaas/api.php/v0';
     ...
     * @var string
     */
    protected $userAgent = 'LTISaasClient V1.0.42';
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "{domain}/local/ltisaas/api.php/v0",
                "description" => "MockData API (Test environment)",
                "variables" => [
                    "domain" => [
                        "description" => "No description provided",
                        "default_value" => "https://linqur45.web09.webv.nl",
                    ]
                ]
            ],
            [
                "url" => "{domain}/local/ltisaas/api.php/v1",
                "description" => "Official LtiSaas API (Production environment)",
                "variables" => [
                    "domain" => [
                        "description" => "No description provided",
                        "default_value" => "https://linqur45.web09.webv.nl",
