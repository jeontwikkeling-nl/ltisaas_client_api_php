...
/**
 * CourseLtiRegistrationsByDay200ResponseResultsInner Class Doc Comment
 *
 * @category Class
 * @package  LtiSaasApi
 * @author   OpenAPI Generator team
 ...
 */
class CourseLtiRegistrationsByDay200ResponseResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'courseLtiRegistrationsByDay_200_response_results_inner';
    ...
    */
     ...
     * Sets date
     *
     * @param \DateTime|null $date The date of the registrations (format: DD-MM-YYYY)
     *
     * @return self
     */
