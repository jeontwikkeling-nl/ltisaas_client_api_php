...
/**
 * CourseGradeSet200Response Class Doc Comment
 *
 * @category Class
 * @package  LtiSaasApi
 * @author   OpenAPI Generator team
 ...
 */
class CourseGradeSet200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'courseGradeSet_200_response';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('finalgrade', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['finalgrade'];
    }

    /**
     * Sets finalgrade
     *
     * @param float|null $finalgrade Final grade set in Moodle scale
     *
     * @return self
     */
    public function setFinalgrade($finalgrade)
    {
        if (is_null($finalgrade)) {
            throw new \InvalidArgumentException('non-nullable finalgrade cannot be null');
        }
        $this->container['finalgrade'] = $finalgrade;
